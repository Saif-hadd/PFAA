...
import { MessageCreateManyInput } from "./MessageCreateManyInput";
...
import { MessageupdateManyArgs } from "./MessageupdateManyArgs";
import { MessageUpdateInput } from "./MessageUpdateInput";
import { Message } from "./Message";
import { getListMessageDto } from "./getListMessage.dto";
...
export class MessageControllerBase {
  ...
  async create(
    ...
    if (invalidAttributes.length) {
      ...
      this.logger.log({
        level: "error",
        message: `providing the properties: ${properties} on ${"Message"} creation is forbidden for roles: ${roles}`,
      });
  ...
  @swagger.ApiForbiddenResponse({ type: errors.ForbiddenException })
  async createMany(
    @common.Body() data: Array<MessageCreateManyInput>,
    @nestAccessControl.UserRoles() userRoles: string[]
  ...
  @swagger.ApiOkResponse({ type: getListMessageDto })
